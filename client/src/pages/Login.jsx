    ...
    <>
      ...
      <div className="auth-root min-h-screen relative flex items-center justify-center bg-[#fafafa] px-4 py-12 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <div className="orb-a absolute -top-40 -left-40 w-[500px] h-[500px] rounded-full bg-indigo-200/40 blur-3xl" />
          <div className="orb-b absolute -bottom-32 -right-32 w-[420px] h-[420px] rounded-full bg-violet-200/35 blur-3xl" />
        </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  autoComplete="email"
                  className={`auth-input w-full px-4 py-3 rounded-xl border bg-gray-50 text-gray-900 placeholder-gray-400 ${error ? "error-ring" : "border-gray-200"}`}
                />
              </div>
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`auth-input w-full px-4 py-3 pr-11 rounded-xl border bg-gray-50 text-gray-900 placeholder-gray-400 ${error ? "error-ring" : "border-gray-200"}`}
                  />
                  <button
                    type="button"
